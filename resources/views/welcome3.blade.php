                   ...
                   <span class="sort-icon">
                    ...
                    Customer relations, sales strategy
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-24.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-7.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Software development
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-3.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-8.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-9.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                    ...
                    Product testing
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-6.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-5.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Financial planning
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-10.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-11.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-12.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                    ...
                    Customer service
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-13.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-14.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Research &amp; development
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-15.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-16.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Operations management
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-17.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-18.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-19.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Technical support
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-20.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-21.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Legal support
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-22.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-23.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Supply chain
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        ...
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-25.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    Supplier management
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-26.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-27.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-28.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                    <span class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-3xs size-[30px] text-info-inverse ring-info-light bg-info">
                     +3
                    ...
                    Employee training
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-29.png') }}" alt=""/>
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="{{ asset('assets/media/avatars/300-30.png') }}" alt=""/>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
