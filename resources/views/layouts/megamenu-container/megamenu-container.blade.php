        ...
        <div class="container-fixed flex justify-between items-stretch lg:gap-4" id="header_container">
            <div class="flex gap-1 lg:hidden items-center -ml-1">
                <a class="shrink-0" href="html/demo1.html">
                    <img class="max-h-[25px] w-full" src="{{ asset('assets/media/app/mini-logo.svg') }}" alt=""/>
                </a>
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <img class="h-5"
                                                             src="{{ asset('assets/media/file-types/figma.svg') }}" alt=""/>
                                                    </div>
                                                    <a class="hover:text-primary-active font-medium text-gray-700 text-xs me-1"
                                                       href="#">
                                                        Launcher-UIkit.fig
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        <img class="h-6"
                                                             src="{{ asset('assets/media/file-types/xls.svg') }}" alt=""/>
                                        ...
                                        <div class="flex grow gap-2.5 px-5">
                                            ...
                                            <div class="flex flex-col gap-3.5 grow">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        <img class="h-6"
                                                             src="{{ asset('assets/media/file-types/word.svg') }}" alt=""/>
                                                        <div class="flex flex-col gap-0.5">
                                                            <a class="hover:text-primary-active font-medium text-gray-700 text-xs"
                                                               href="#">
                                                                Landing-page.docx
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        <img class="h-6"
                                                             src="{{ asset('assets/media/file-types/svg.svg') }}" alt=""/>
                                                        <div class="flex flex-col gap-0.5">
                                                            <a class="hover:text-primary-active font-medium text-gray-700 text-xs"
                                                               href="#">
                                                                New-icon.svg
                                                ...
                                                <div class="flex items-center gap-2.5">
                                                    <div
                                                        ...
                                                        <div class="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24"
                                                             style="background-image: url({{ asset('/static/metronic-tailwind-html/dist/assets/media/images/600x600/6.jpg') }})">
                                                    ...
                                                    <div
                                                        class="card shadow-none flex flex-col gap-3.5 bg-light-active w-40">
                                                        <div class="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24"
                                                             style="background-image: url({{ asset('/static/metronic-tailwind-html/dist/assets/media/images/600x600/1.jpg') }})">
                                            ...
                                            <div class="flex flex-col gap-2.5 grow" id="notification_request_17">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <img class="h-5"
                                                             src="{{ asset('assets/media/brand-logos/jira.svg') }}" alt=""/>
                                                    </div>
                                                    <a class="hover:text-primary-active font-medium text-gray-700 text-xs me-1"
                                                       href="#">
                                                        User-feedback.jira
                                    ...
                                    <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="html/demo1/account/security/overview.html">
                                                ...
                                                <label class="switch switch-sm">
                                                    < checked="" name="check" type="checkbox" value="1"/>
                                                </label>
                                            </a>
                                        </div>
                                    </div>
